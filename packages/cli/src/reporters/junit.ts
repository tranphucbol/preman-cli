...
import type { GroupRunItem, RunOutcome } from "@preman/core/runner.js";
import { originTag } from "@preman/cli/render/outcome.js";
import type { ReportableRun, Reporter } from "./index.js";
...
function renderJunit(result: ReportableRun): string {
  const suites =
    result.kind === "single"
