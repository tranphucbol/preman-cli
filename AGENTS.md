...
eslint.config.js      lint and import-layering rules
...
- TypeScript strict, ESM. Import with explicit `.js` specifiers; use `@/` outside the current directory,
  relative imports within it, and `import type` for types.
